...
__all__ = ['LocalConnectorArgs', 'LocalConnector']

@pulumi.input_type
class LocalConnectorArgs:
...
@pulumi.type_token("dex:resources:LocalConnector")
class LocalConnector(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LocalConnectorArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LocalConnectorArgs.__new__(LocalConnectorArgs)
        ...
        super(LocalConnector, __self__).__init__(
            'dex:resources:LocalConnector',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'LocalConnector':
        """
        ...
        return LocalConnector(resource_name, opts=opts, __props__=__props__)
